...
VALUES 
    ('1000000001', 'Alice Johnson', 500000.0000, 'NGN', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('1000000002', 'Bob Smith', 250000.0000, 'NGN', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('1000000003', 'Charlie Brown (Low Balance)', 50.0000, 'NGN', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
